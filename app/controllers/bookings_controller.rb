class BookingsController < ApplicationController
  ...
  def create_booking
    ...
    if @booking.save
      redirect_to current_user, notice: 'Booking was successfully created.'
    else
  ...
  def destroy
    @booking.destroy
    respond_to do |format|
      format.html { redirect_to car_bookings_path(@car), notice: 'Booking was successfully destroyed.' }
  ...
  private
    ...
    def booking_params
      params.require(:booking).permit(:email_id, :phone, :place, :car_id, :start_time, :end_time)
    end
end
